      ...
      <div className={styles.container}>
        <div className={styles.leftSection}>
          ...
          <ul className={styles.linksList}>
            <li className={styles.listItem}><a href="#" className={styles.link}>Consultation</a></li>
        ...
        <div className={styles.middleSection}>
          ...
          <p className={styles.contactEmail}>Contact: <a href="mailto:hi.clinic@vetclinicpoznan.com">hi.clinic@vetclinicpoznan.com</a></p>
        ...
        <div className={styles.rightSection}>
          ...
          <p className={styles.ourServices}>Our services are wide open for you</p>
          <button className={styles.bookingButton}>Booking</button>
        </div>
      </div>
      <div className={styles.copyright}>
        ©VetClinicPoznan.co • <a href="#" className={styles.privacyLink}>Terms and Privacy Policy</a>
      </div>
    </footer>
  );
};
